...
<!-- Inicio popup para agregar gasto -->
<div class="overlay" id="overlay-gasto">

    <div class="popup" id="popup-gasto">

        <a href="#" id="btn-cerrar-popup-gasto" class="btn-cerrar-popup">
            <i class="fas fa-times"></i>
        </a>

        <h3>Agregar gasto</h3>

        <form action="${pageContext.request.contextPath}/MovimientoController?accion=insertarGasto" method="post" class="formulario" id="formulario">

            <div class="contenedor-inputs">
                
                <div class="formulario__grupo" id="grupo__total">
                    <label class="formulario__label dis-block text-danger">
                        Cantidad maxima a gastar &nbsp; <fmt:formatNumber value="${totalFree}" type="currency" />
                    </label>
                ...
                <div class="formulario__grupo" id="grupo__monto">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input w-100 h-45-lh-45 p-0-40-0-10" id="monto" name="monto" value="-">
